...
class BeyondCollectionSummaryDetail extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fir_man_det_effective_registries' => 'Primera Gestión - Registros efectivos',
            'fir_man_det_effective_registries_percentage' => 'Primera Gestión - Registros efectivos porcentaje',
            'fir_man_det_effective_registries_payment_promise_scheduled' => 'Primera Gestión - Registros efectivos - Agenda promesa de pago',
            'fir_man_det_effective_registries_online_payment' => 'Primera Gestión - Registros efectivos - Paga en línea',
            'fir_man_det_effective_registries_new_policy_accepted' => 'Primera Gestión - Registros efectivos - Acepta póliza nueva',
            'fir_man_det_effective_registries_accepted_direct_debit_payment' => 'Primera Gestión - Registros efectivos - Acepta Pago con 5% por domiciliación',
            'fir_man_det_effective_registries_deposit_slip_sent' => 'Primera Gestión - Registros efectivos - Se envía ficha de depósito',
            'fir_man_det_on_track_registries' => 'Primera Gestión - Registros en seguimiento',
            'fir_man_det_on_track_registries_percentage' => 'Primera Gestión - Registros en seguimiento porcentaje',
            'fir_man_det_on_track_registries_call_scheduled' => 'Primera Gestión - Registros en seguimiento - Agenda llamada',
            'fir_man_det_on_track_registries_detail_does_not_answer' => 'Primera Gestión - Registros en seguimiento - No contesta',
            'fir_man_det_on_track_registries_voice_mail' => 'Primera Gestión - Registros en seguimiento - Buzón',
            'fir_man_det_out_of_management_registries' => 'Primera Gestión - Registros fuera de gestión',
            'fir_man_det_out_of_management_registries_percentage' => 'Primera Gestión - Registros fuera de gestión porcentaje',
            'fir_man_det_out_of_management_registries_wrong_number' => 'Primera Gestión - Registros fuera de gestión - Número equivocado',
            'fir_man_det_out_of_management_registries_policy_cancelled' => 'Primera Gestión - Registros fuera de gestión - Contrato cancelado (Póliza cancelada)',
            'fir_man_det_out_of_management_registries_does_not_answer' => 'Primera Gestión - Registros fuera de gestión - No contesta',
            'fir_man_det_out_of_management_registries_complaint' => 'Primera Gestión - Registros fuera de gestión - Queja',
            'fir_man_det_out_of_management_registries_not_manageable' => 'Primera Gestión - Registros fuera de gestión - No gestionable en portal (ZA)',
            'fir_man_det_out_of_management_registries_lost_registry' => 'Primera Gestión - Registros fuera de gestión - Registro perdido',

            'sec_man_det_effective_registries' => 'Segunda Gestión - Registros efectivos',
            'sec_man_det_effective_registries_percentage' => 'Segunda Gestión - Registros efectivos porcentaje',
            'sec_man_det_effective_registries_payment_promise_scheduled' => 'Segunda Gestión - Registros efectivos - Agenda promesa de pago',
            'sec_man_det_effective_registries_online_payment' => 'Segunda Gestión - Registros efectivos - Paga en línea',
            'sec_man_det_effective_registries_new_policy_accepted' => 'Segunda Gestión - Registros efectivos - Acepta póliza nueva',
            'sec_man_det_effective_registries_accepted_direct_debit_payment' => 'Segunda Gestión - Registros efectivos - Acepta Pago con 5% por domiciliación',
            'sec_man_det_effective_registries_deposit_slip_sent' => 'Segunda Gestión - Registros efectivos - Se envía ficha de depósito',
            'sec_man_det_on_track_registries' => 'Segunda Gestión - Registros en seguimiento',
            'sec_man_det_on_track_registries_percentage' => 'Segunda Gestión - Registros en seguimiento porcentaje',
            'sec_man_det_on_track_registries_call_scheduled' => 'Segunda Gestión - Registros en seguimiento - Agenda llamada',
            'sec_man_det_on_track_registries_does_not_answer' => 'Segunda Gestión - Registros en seguimiento - No contesta',
            'sec_man_det_on_track_registries_voice_mail' => 'Segunda Gestión - Registros en seguimiento - Buzón',
            'sec_man_det_out_of_management_registries' => 'Segunda Gestión - Registros fuera de gestión',
            'sec_man_det_out_of_management_registries_percentage' => 'Segunda Gestión - Registros fuera de gestión porcentaje',
            'sec_man_det_out_of_management_registries_wrong_number' => 'Segunda Gestión - Registros fuera de gestión - Número equivocado',
            'sec_man_det_out_of_management_registries_policy_cancelled' => 'Segunda Gestión - Registros fuera de gestión - Contrato cancelado (Póliza cancelada)',
            'sec_man_det_out_of_management_registries_does_not_answer' => 'Segunda Gestión - Registros fuera de gestión - No contesta',
            'sec_man_det_out_of_management_registries_complaint' => 'Segunda Gestión - Registros fuera de gestión - Queja',
            'sec_man_det_out_of_management_registries_not_manageable' => 'Segunda Gestión - Registros fuera de gestión - No gestionable en portal (ZA)',
            'sec_man_det_out_of_management_registries_lost_registry' => 'Segunda Gestión - Registros fuera de gestión - Registro perdido',

            'thir_man_det_effective_registries' => 'Tercera Gestión - Registros efectivos',
            'thir_man_det_effective_registries_percentage' => 'Tercera Gestión - Registros efectivos porcentaje',
            'thir_man_det_effective_registries_payment_promise_scheduled' => 'Tercera Gestión - Registros efectivos - Agenda promesa de pago',
            'thir_man_det_effective_registries_online_payment' => 'Tercera Gestión - Registros efectivos - Paga en línea',
            'thir_man_det_effective_registries_new_policy_accepted' => 'Tercera Gestión - Registros efectivos - Acepta póliza nueva',
            'thir_man_det_effective_registries_accepted_direct_debit_payment' => 'Tercera Gestión - Registros efectivos - Acepta Pago con 5% por domiciliación',
            'thir_man_det_effective_registries_deposit_slip_sent' => 'Tercera Gestión - Registros efectivos - Se envía ficha de depósito',
            'thir_man_det_on_track_registries' => 'Tercera Gestión - Registros en seguimiento',
            'thir_man_det_on_track_registries_percentage' => 'Tercera Gestión - Registros en seguimiento porcentaje',
            'thir_man_det_on_track_registries_call_scheduled' => 'Tercera Gestión - Registros en seguimiento - Agenda llamada',
            'thir_man_det_on_track_registries_does_not_answer' => 'Tercera Gestión - Registros en seguimiento - No contesta',
            'thir_man_det_on_track_registries_voice_mail' => 'Tercera Gestión - Registros en seguimiento - Buzón',
            'thir_man_det_out_of_management_registries' => 'Tercera Gestión - Registros fuera de gestión',
            'thir_man_det_out_of_management_registries_percentage' => 'Tercera Gestión - Registros fuera de gestión porcentaje',
            'thir_man_det_out_of_management_registries_wrong_number' => 'Tercera Gestión - Registros fuera de gestión - Número equivocado',
            'thir_man_det_out_of_management_registries_policy_cancelled' => 'Tercera Gestión - Registros fuera de gestión - Contrato cancelado (Póliza cancelada)',
            'thir_man_det_out_of_management_registries_does_not_answer' => 'Tercera Gestión - Registros fuera de gestión - No contesta',
            'thir_man_det_out_of_management_registries_complaint' => 'Tercera Gestión - Registros fuera de gestión - Queja',
            'thir_man_det_out_of_management_registries_not_manageable' => 'Tercera Gestión - Registros fuera de gestión - No gestionable en portal (ZA)',
            'thir_man_det_out_of_management_registries_lost_registry' => 'Tercera Gestión - Registros fuera de gestión - Registro perdido',

            'four_man_det_effective_registries' => 'Tercera Gestión - Registros efectivos',
            'four_man_det_effective_registries_percentage' => 'Tercera Gestión - Registros efectivos porcentaje',
            'four_man_det_effective_registries_payment_promise_scheduled' => 'Tercera Gestión - Registros efectivos - Agenda promesa de pago',
            'four_man_det_effective_registries_online_payment' => 'Tercera Gestión - Registros efectivos - Paga en línea',
            'four_man_det_effective_registries_new_policy_accepted' => 'Tercera Gestión - Registros efectivos - Acepta póliza nueva',
            'four_man_det_effective_registries_accepted_direct_debit_payment' => 'Tercera Gestión - Registros efectivos - Acepta Pago con 5% por domiciliación',
            'four_man_det_effective_registries_deposit_slip_sent' => 'Tercera Gestión - Registros efectivos - Se envía ficha de depósito',
            'four_man_det_on_track_registries' => 'Tercera Gestión - Registros en seguimiento',
            'four_man_det_on_track_registries_percentage' => 'Tercera Gestión - Registros en seguimiento porcentaje',
            'four_man_det_on_track_registries_call_scheduled' => 'Tercera Gestión - Registros en seguimiento - Agenda llamada',
            'four_man_det_on_track_registries_does_not_answer' => 'Tercera Gestión - Registros en seguimiento - No contesta',
            'four_man_det_on_track_registries_voice_mail' => 'Tercera Gestión - Registros en seguimiento - Buzón',
            'four_man_det_out_of_management_registries' => 'Tercera Gestión - Registros fuera de gestión',
            'four_man_det_out_of_management_registries_percentage' => 'Tercera Gestión - Registros fuera de gestión porcentaje',
            'four_man_det_out_of_management_registries_wrong_number' => 'Tercera Gestión - Registros fuera de gestión - Número equivocado',
            'four_man_det_out_of_management_registries_policy_cancelled' => 'Tercera Gestión - Registros fuera de gestión - Contrato cancelado (Póliza cancelada)',
            'four_man_det_out_of_management_registries_does_not_answer' => 'Tercera Gestión - Registros fuera de gestión - No contesta',
            'four_man_det_out_of_management_registries_complaint' => 'Tercera Gestión - Registros fuera de gestión - Queja',
            'four_man_det_out_of_management_registries_not_manageable' => 'Tercera Gestión - Registros fuera de gestión - No gestionable en portal (ZA)',
            'four_man_det_out_of_management_registries_lost_registry' => 'Tercera Gestión - Registros fuera de gestión - Registro perdido',
