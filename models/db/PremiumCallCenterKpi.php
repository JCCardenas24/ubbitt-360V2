...
/**
 * This is the  class for table "premium_call_center_kpi".
 *
 ...
 *
 */
class PremiumCallCenterKpi extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'premium_call_center_kpi';
    }
    ...
    {
        return [
            [['campaign_id', 'date', 'inbound_calls', 'answered_calls', 'outbound_calls', 'lost_calls', 'calls_answered_within_25_seconds', 'nsl_percentage', 'abandoned_before_5_seconds', 'abandonment', 'ath', 'average_time_in_answering_call', 'speaking_time'], 'required'],
            [['campaign_id', 'inbound_calls', 'answered_calls', 'outbound_calls', 'lost_calls', 'calls_answered_within_25_seconds', 'abandoned_before_5_seconds'], 'integer'],
    ...
    public function findByDates($campaignId, $startDate, $endDate)
    {
        ...
        $data['speaking_time'] = $this->findSpeakingTimeSum($campaignId, $startDate, $endDate);
        return $data;
    }

    private function findSpeakingTimeSum($campaignId, $startDate, $endDate)
    {
        $kpis = self::find()
