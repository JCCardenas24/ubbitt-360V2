...
/**
 * This is the  class for table "beyond_renewal_call_center_kpi".
 *
 * @property date $date
 ...
 *
 */
class BeyondRenewalCallCenterKpi extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'beyond_renewal_call_center_kpi';
    }
    ...
    public function findKpisReport($startDate, $endDate)
    {
        $data = Yii::$app->db->createCommand('
            SELECT COALESCE(SUM(inbound_calls), 0) AS inbound_calls,
                ...
                FROM beyond_renewal_call_center_kpi
