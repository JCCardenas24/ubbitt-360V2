window.onload = function () {
    ...
    menu.children[2].children[1].children[2].classList.add('c-yellow');
    header.textContent = 'KPIs Telefonía';
};
...
$(function () {
    ...
    function cb(start, end, refresh = true) {
        $('#reportrange_kpis_telefonia span').html(
    ...
    $('#reportrange_kpis_telefonia').daterangepicker(
        {
            startDate: start,
            endDate: end,
            ranges: {
