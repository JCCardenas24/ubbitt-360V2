window.onload = function () {
    ...
    menu.children[2].children[1].children[0].classList.add('c-yellow');
    header.textContent = 'Panel producción cobranza';
};
...
$(function () {
    ...
    function cb(start, end, refresh = true) {
        $('#reportrange_informes span').html(
    ...
    $('#reportrange_informes').daterangepicker(
        {
            startDate: start,
            endDate: end,
            ranges: {
