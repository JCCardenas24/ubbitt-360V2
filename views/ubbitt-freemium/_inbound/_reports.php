<ul class="nav nav-pills level-four" id="freemium-inbound-reportes-options" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="nav-link nav-link-freemium-reports active" data-tab-type="kpis" id="freemium-inbound-reportes-detalle-kpis-tab" data-toggle="pill"
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link nav-link-freemium-reports" data-tab-type="advisor" data-toggle="pill" href="#freemium-inbound-reportes-detalle-kpis" role="tab"
            aria-controls="freemium-inbound-reportes-detalle-kpis" aria-selected="false">Productividad de asesores</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link nav-link-freemium-reports" data-tab-type="trackers" data-toggle="pill" href="#freemium-inbound-reportes-detalle-kpis" role="tab"
            aria-controls="freemium-inbound-reportes-detalle-kpis" aria-selected="false">Detalle de tipificaciones</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link nav-link-freemium-reports" data-tab-type="quality-daily" data-toggle="pill" href="#freemium-inbound-reportes-detalle-kpis" role="tab"
            aria-controls="freemium-inbound-reportes-detalle-kpis" aria-selected="false">De calidad diario</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link nav-link-freemium-reports" data-tab-type="quality-general" data-toggle="pill" href="#freemium-inbound-reportes-detalle-kpis" role="tab"
            aria-controls="freemium-inbound-reportes-detalle-kpis" aria-selected="false">General de calidad</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link nav-link-freemium-reports" data-tab-type="calibrations" data-toggle="pill" href="#freemium-inbound-reportes-detalle-kpis" role="tab"
