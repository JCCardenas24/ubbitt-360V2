    ...
    <div class="d-flex wid-100 justify-content-end">
        <div class="col-5 d-flex justify-content-between">
            <div class="form-group wid-100 d-flex m-0">
                <div id="beyond-renewal-report-date-range" class="range-pick">
    ...
    <div class="col-md-6 mx-auto text-center div-white pt-15 pb-15 rounded mt-30">
        ...
        <div class="mt-4">
            ...
            <div class="custom-file col-10">
                ...
                <?= $formUploadReport->field($reportFileModel, 'module_origin')->hiddenInput(['id' => 'module-origin', 'value' => 'beyond']) ?>
                <?= $formUploadReport->field($reportFileModel, 'submodule_origin')->hiddenInput(['id' => 'submodule-origin', 'value' => 'renewal']) ?>
