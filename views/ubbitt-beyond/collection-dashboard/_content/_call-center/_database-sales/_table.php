<div class="table-responsive wrapper_table_fixed_last_column">
    <table class="table table-hover table_fixed_last_column" id="beyond-collection-sales-table">
        <thead>
            <tr>
                <th scope="col">ID</th>
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-end" id="beyond-collection-sales-paginator">
